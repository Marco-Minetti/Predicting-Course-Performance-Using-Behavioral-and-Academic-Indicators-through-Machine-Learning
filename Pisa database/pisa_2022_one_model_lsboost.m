%% Board 38 - PISA 2022 One-Model Big Prediction
% Goal:
...
resultsFolder = fullfile(pwd, "pisa_2022_one_model_results");
...
numBoostTrees = 550;          % More trees = better but slower
learnRate = 0.04;             % Lower = more stable, usually needs more trees
maxNumSplits = 90;            % Bigger trees capture more complex patterns
minLeafSize = 15;             % Lower = more flexible, higher = faster/smoother

fprintf("===== PISA 2022 One-Model Big Prediction =====\n");
...
%% =========================
Results = table;
Results.Model = "LSBoost One-Model";
...
writetable(Results, fullfile(resultsFolder, "one_model_regression_results.csv"));
...
hold off;
saveas(fig1, fullfile(resultsFolder, "one_model_predicted_vs_actual.png"));
...
hold off;
saveas(fig2, fullfile(resultsFolder, "one_model_residuals.png"));
...
writetable(importanceTable, fullfile(resultsFolder, "one_model_feature_importance.csv"));
...
grid on;
saveas(fig3, fullfile(resultsFolder, "one_model_feature_importance.png"));
...
% SUMMARY REPORT
%% =========================
fileID = fopen(fullfile(resultsFolder, "one_model_summary_report.txt"), "w");

fprintf(fileID, "PISA 2022 One-Model LSBoost Summary\n");
fprintf(fileID, "===================================\n\n");
